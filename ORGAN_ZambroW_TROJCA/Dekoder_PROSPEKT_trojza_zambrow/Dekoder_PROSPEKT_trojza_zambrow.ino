...
int pins_PED_PR_16[] = {19, 18, 21, 20, 23, 22, 25, 24, 27, 26, 29, 28};
int pins_PED_OCTVBAS_8[] = {3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12};
int pins_M_I_PR_8[] = {A14, A15, A12, A13, A10, A11, A8, A9, A6, A7, A4, A5};
int pins_M_II_PR_8[] = {46, 47, 44, 45, 42, 43, 40};

int remaining_pins[] = {A2, A3, A0, A1,    41, 38, 39, 36, 37, 34, 35, 32, 33, 31, 30,  15, 14, 17, 16}; // unused pins
// 
// for man II :
